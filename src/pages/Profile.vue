...
.profile-header .profile-info .avatar {
    width: 100px;
    height: 100px;
    border-radius: 50%;
    margin-right: 20px;
...
.profile-header .profile-info button.edit-btn {
...
/* .profile-header .profile-info button.edit-btn:hover {
...
.svg-f {
  display: flex;
  justify-content: space-between; /* Đưa các phần tử con ra hai đầu */
